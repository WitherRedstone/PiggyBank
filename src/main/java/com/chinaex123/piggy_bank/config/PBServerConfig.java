...
public class PBServerConfig {
    ...
    public static final ModConfigSpec.ConfigValue<List<? extends String>> MOD_NAMESPACE_WHITELIST;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> MOD_NAMESPACE_BLACKLIST;
